...
export const uploadReport = async(req: Request, res: Response) => {
    ...
    const {parc, teamMembers, data, oreLucrate, inductieOre, mediuOre} = req.body as DailyReport;

    if (!parc || !teamMembers?.length || !data || oreLucrate == null || inductieOre == null || mediuOre == null) {
